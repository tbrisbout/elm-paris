...
nextMeetup =
    ...
    , lineUp =
        [ { speaker = tbrisbout
          , title = "elm-css"
          , link = Just "https://slides.com/thomasbrisbout/elm-css/fullscreen#/"
        ...
        , { speaker = n_umiastowski
          ...
          , link = Just "http://slides.com/numiastowski/deck/fullscreen"
          , description = "Nous verrons dans ce talk comment un système de type peut aider à faire du CSS de manière fiable: Imaginez par exemple être notifié sur une typo dans un nom de classe..."
          }
        , { speaker = klebrun
          , title = "Elm + Polymer = <3"
          ...
          , link = Just "http://slides.com/kevinlebrun/elm-polymer-3/fullscreen"
          }
        , { speaker = tibastral
...
meetup1 =
    ...
    , lineUp =
        [ { speaker = tbrisbout
          ...
          , link = Just "http://slides.com/thomasbrisbout/elm-intro/fullscreen"
          }
        , { speaker = jumichot
          ...
          , link = Just "http://slides.com/jumichot/elm-signals/fullscreen"
          }
        , { speaker = klebrun
          ...
          , link = Just "http://slides.com/kevinlebrun/real-world-elm/fullscreen"
          }
        ]
    }
...
meetup2 =
    ...
    , lineUp =
        [ { speaker = tbrisbout
          ...
          , description = ""
          , link = Just "http://slides.com/thomasbrisbout/elm-electron/fullscreen"
          }
        , { speaker = jumichot
...
meetup3 =
    ...
    , lineUp =
        [ { speaker = tbrisbout
          ...
          , link = Just "http://slides.com/thomasbrisbout/elm-testing/fullscreen"
          }
        , { speaker = tellijo
          , title = "Routeur SPA en Elm"
          , description = ""
          , link = Just "http://slides.com/tellijo/routing-elm/fullscreen"
          }
        , { speaker = klebrun
          ...
          , link = Just "http://slides.com/kevinlebrun/from-elm016-to-elm017/fullscreen"
          }
        , { speaker = abaumann
          ...
          , link = Just "https://youtu.be/w11dtJawNE0?list=PLFmYNJ_DUU2DPZH2Vfok0jdfkGPcrL0JA"
          }
        ]
    }
